...
uint8_t PlayGameState::decreaseHighlightButton_GamePlayButtons(uint8_t highlightedButton) {
	...
	if (highlightedButton == 3 && currentBetInit <= player.purse && ((this->player.firstHand.cardCount == 2 && handInPlay == FIRST_HAND) || (this->player.secondHand.cardCount == 2 && handInPlay == SECOND_HAND))) return 2;
...
uint8_t PlayGameState::increaseHighlightButton_GamePlayButtons(uint8_t highlightedButton) {
	...
	if (highlightedButton <= 1 && (currentBetInit <= player.purse && ((this->player.firstHand.cardCount == 2 && handInPlay == FIRST_HAND) || (this->player.secondHand.cardCount == 2 && handInPlay == SECOND_HAND)))) return 2;
